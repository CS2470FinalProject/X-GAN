...
parser.add_argument('--load_size', dest='load_size', type=int, default=, help='scale images to this size')
...
parser.add_argument('--dann_weight', dest='dann_weight', type=float, default=, help='weight on domain-adversarial loss')
parser.add_argument('--sem_weight', dest='sem_weight', type=float, default=, help='weight on semantic consistency loss')
parser.add_argument('--gan_weight', dest='gan_weight', type=float, default=, help='weight on gan loss')
